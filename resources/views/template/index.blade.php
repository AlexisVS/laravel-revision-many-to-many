...
<body class="antialiased">
  <div
    class="relative flex flex-col items-top justify-center min-h-screen text-gray-50 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    @if (Route::has('login'))
    ...
    <a href="/">
      ...
      <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg"
        class="w-full h-1/12 text-gray-700 sm:h-20">
